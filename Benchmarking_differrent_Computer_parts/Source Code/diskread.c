...
// 4 threads
	...
	for (i=0;i<6;i++)
	{
		...
		printf ("Block Size: \t%ld Bytes\t%ld Bytes\t%ld Bytes\t%ld Bytes\t%ld Bytes\t%ld Bytes\t%ld Bytes\t%ld Bytes\n", StrctSeq[i][0].size_of_block,
				 StrctSeq[i][1].size_of_block, StrctSeq[i][2].size_of_block,StrctSeq[i][3].size_of_block,
				 StrctSeq[i][4].size_of_block,StrctSeq[i][5].size_of_block,StrctSeq[i][6].size_of_block,StrctSeq[i][7].size_of_block,
				 StrctSeq[i][7].size_of_block);
		printf ("No. of Blocks: \t%ld\t%ld\t%ld\t%ld\t%ld\t%ld\t%ld\t%ld\t%ld\n", StrctSeq[i][0].lngNoOfBlocks,
				StrctSeq[i][1].lngNoOfBlocks,StrctSeq[i][2].lngNoOfBlocks,StrctSeq[i][3].lngNoOfBlocks,StrctSeq[i][4].lngNoOfBlocks,StrctSeq[i][5].lngNoOfBlocks,StrctSeq[i][6].lngNoOfBlocks,
				StrctSeq[i][7].lngNoOfBlocks,
				(StrctSeq[i][0].lngNoOfBlocks + StrctSeq[i][1].lngNoOfBlocks+StrctSeq[i][2].lngNoOfBlocks + StrctSeq[i][3].lngNoOfBlocks
				+ StrctSeq[i][4].lngNoOfBlocks+ StrctSeq[i][5].lngNoOfBlocks+ StrctSeq[i][6].lngNoOfBlocks+ StrctSeq[i][7].lngNoOfBlocks) );
		printf ("Total Memory Size: \t%ld Bytes\t%ld Bytes\t%ld Bytes\t%ld Bytes\t%ld Bytes\t%ld Bytes\t%ld Bytes\t%ld Bytes\t%ld Bytes\n", StrctSeq[i][0].lngTotalMemSize,
				StrctSeq[i][1].lngTotalMemSize, StrctSeq[i][2].lngTotalMemSize,StrctSeq[i][3].lngTotalMemSize,StrctSeq[i][4].lngTotalMemSize,StrctSeq[i][5].lngTotalMemSize,
				StrctSeq[i][6].lngTotalMemSize,StrctSeq[i][7].lngTotalMemSize,
				(StrctSeq[i][0].lngTotalMemSize + StrctSeq[i][1].lngTotalMemSize,
				StrctSeq[i][2].lngTotalMemSize + StrctSeq[i][3].lngTotalMemSize+ StrctSeq[i][4].lngTotalMemSize+ StrctSeq[i][5].lngTotalMemSize+ StrctSeq[i][6].lngTotalMemSize+ StrctSeq[i][7].lngTotalMemSize) );
		printf ("Throughput: \t%7.4f MBPS\t%7.4f MBPS\t%7.4f MBPS\t%7.4f MBPS\t%7.4f MBPS\t%7.4f MBPS\t%7.4f MBPS\t%7.4f MBPS\t%7.4f MBPS\n", StrctSeq[i][0].dblThroughput,
				StrctSeq[i][1].dblThroughput, StrctSeq[i][2].dblThroughput,StrctSeq[i][3].dblThroughput,StrctSeq[i][4].dblThroughput,StrctSeq[i][5].dblThroughput,
				StrctSeq[i][6].dblThroughput,StrctSeq[i][7].dblThroughput,
				(StrctSeq[i][0].dblThroughput + StrctSeq[i][1].dblThroughput+StrctSeq[i][2].dblThroughput + StrctSeq[i][3].dblThroughput
				+ StrctSeq[i][4].dblThroughput+ StrctSeq[i][5].dblThroughput+ StrctSeq[i][6].dblThroughput+ StrctSeq[i][7].dblThroughput));
		printf ("Latency: \t%02.15f milliSec\t%02.15f milliSec\t%02.15f milliSec\t%02.15f milliSec\t%02.15f milliSec\t%02.15f milliSec\t%02.15f milliSec\t%02.15f milliSec\t%02.15f milliSec\n\n", StrctSeq[i][0].dblLatency,
				StrctSeq[i][1].dblLatency, StrctSeq[i][2],StrctSeq[i][3],StrctSeq[i][4],StrctSeq[i][5],StrctSeq[i][6],StrctSeq[i][7],
				(StrctSeq[i][0].dblLatency + StrctSeq[i][1].dblLatency
				+StrctSeq[i][2].dblLatency + StrctSeq[i][3].dblLatency+ StrctSeq[i][4].dblLatency+ StrctSeq[i][5].dblLatency+ StrctSeq[i][6].dblLatency
				+ StrctSeq[i][7].dblLatency)/7 );
				}
	...
	for (i=0;i<6;i++)
	{
		...
		printf ("Block Size: \t%ld Bytes\t%ld Bytes\t%ld Bytes\t%ld Bytes\t%ld Bytes\t%ld Bytes\t%ld Bytes\t%ld Bytes\t%ld Bytes\n", StrctRand[i][0].size_of_block,
				 StrctRand[i][1].size_of_block, StrctRand[i][2].size_of_block,StrctRand[i][3].size_of_block,StrctRand[i][4].size_of_block,
				 StrctRand[i][5].size_of_block,StrctRand[i][6].size_of_block,StrctRand[i][7].size_of_block,StrctRand[i][7].size_of_block);
		printf ("No. of Blocks: \t%ld\t%ld\t%ld\t%ld\t%ld\t%ld\t%ld\t%ld\t%ld\n", StrctRand[i][0].lngNoOfBlocks,
				StrctRand[i][1].lngNoOfBlocks, StrctRand[i][2].lngNoOfBlocks,StrctRand[i][3].lngNoOfBlocks,StrctRand[i][4].lngNoOfBlocks,StrctRand[i][5].lngNoOfBlocks,
				StrctRand[i][6].lngNoOfBlocks,StrctRand[i][7].lngNoOfBlocks,
				(StrctRand[i][0].lngNoOfBlocks+StrctRand[i][1].lngNoOfBlocks
				+StrctRand[i][2].lngNoOfBlocks+StrctRand[i][3].lngNoOfBlocks+StrctRand[i][4].lngNoOfBlocks+StrctRand[i][5].lngNoOfBlocks
				+StrctRand[i][6].lngNoOfBlocks+StrctRand[i][7].lngNoOfBlocks));
		printf ("Total Memory Size: \t%ld Bytes\t%ld Bytes\t%ld Bytes\t%ld Bytes\t%ld Bytes\t%ld Bytes\t%ld Bytes\n", StrctRand[i][0].lngTotalMemSize,
				StrctRand[i][1].lngTotalMemSize, StrctRand[i][2].lngTotalMemSize,StrctRand[i][3].lngTotalMemSize,
				StrctRand[i][4].lngTotalMemSize,StrctRand[i][5].lngTotalMemSize,StrctRand[i][6].lngTotalMemSize,StrctRand[i][7].lngTotalMemSize,(StrctRand[i][0].lngTotalMemSize+
				StrctRand[i][1].lngTotalMemSize+StrctRand[i][2].lngTotalMemSize+StrctRand[i][3].lngTotalMemSize
				+StrctRand[i][4].lngTotalMemSize+StrctRand[i][5].lngTotalMemSize+StrctRand[i][6].lngTotalMemSize+StrctRand[i][7].lngTotalMemSize));
		printf ("Throughput: \t%7.4f MBPS\t%7.4f MBPS\t%7.4f MBPS\t%7.4f MBPS\t%7.4f MBPS\t%7.4f MBPS\t%7.4f MBPS\t%7.4f MBPS\t%7.4f MBPS\n", StrctRand[i][0].dblThroughput,
				StrctRand[i][1].dblThroughput, StrctRand[i][2].dblThroughput,StrctRand[i][3].dblThroughput,StrctRand[i][3].dblThroughput,StrctRand[i][4].dblThroughput,
				StrctRand[i][5].dblThroughput,StrctRand[i][6].dblThroughput,StrctRand[i][7].dblThroughput,
				(StrctRand[i][0].dblThroughput+StrctRand[i][1].dblThroughput+StrctRand[i][2].dblThroughput+StrctRand[i][3].dblThroughput
				+StrctRand[i][4].dblThroughput+StrctRand[i][5].dblThroughput+StrctRand[i][6].dblThroughput+StrctRand[i][7].dblThroughput));
		printf ("Latency: \t%02.15f milliSec\t%02.15f milliSec\t%02.15f milliSec\t%02.15f milliSec\t%02.15f milliSec\t%02.15f milliSec\t%02.15f milliSec\t%02.15f milliSec\t%02.15f milliSec\n\n", StrctRand[i][0].dblLatency,
				StrctRand[i][1].dblLatency, StrctRand[i][2].dblLatency ,StrctRand[i][3].dblLatency,StrctRand[i][4].dblLatency,StrctRand[i][5].dblLatency,
				StrctRand[i][6].dblLatency,StrctRand[i][7].dblLatency,
				(StrctRand[i][0].dblLatency+StrctRand[i][1].dblLatency+StrctRand[i][2].dblLatency+StrctRand[i][3].dblLatency
				+StrctRand[i][4].dblLatency+StrctRand[i][5].dblLatency+StrctRand[i][6].dblLatency+StrctRand[i][7].dblLatency)/7);
			}	
	}
